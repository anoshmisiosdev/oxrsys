...
`clients/SteamVR/openvr/openvr_driver.h` is Valve Corporation's OpenVR driver header, vendored unchanged and covered by the OpenVR SDK license, not by MPL-2.0.
