...
import Foundation
import XCTest
@testable import OXRSys_Home

private struct HomeLauncherTestFailure: Error, CustomStringConvertible {
    let description: String
}

@MainActor
final class HomeLauncherTests: XCTestCase {
    func testBundleInspection() throws {
    ...
    func testLauncherMergeDeduplicatesManualApps() throws {
    ...
    func testTerminalScriptQuoting() throws {
        let app = LauncherApp(
            name: "Quoted App",
    ...
    func testQuestUsbDeviceParsing() throws {
    ...
    func testQuestUsbDeviceParsingWithoutHeader() throws {
        let devices = QuestUsbBridge.parseDevices("""
        1WMHH000000000 device usb:336592896X product:hollywood model:Quest_3 device:eureka transport_id:4
        ABC unauthorized usb:1-1 transport_id:5
        """)
    ...
    func testQuestUsbReverseParsing() throws {
    ...
    func testQuestUsbAdbCandidatePaths() throws {
    ...
    func testPackagedRuntimeManifestDefault() throws {
        let root = try temporaryDirectory()
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testQuestUsbAdbCustomPathOrdering() throws {
        let candidates = QuestUsbBridge.adbCandidatePaths(
    ...
    func testQuestUsbAdbCustomResolution() throws {
        let root = try temporaryDirectory()
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testQuestUsbAdbInvalidCustomStatus() throws {
        let root = try temporaryDirectory()
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testQuestUsbAdbClearRestoresAutoDetection() throws {
        let root = try temporaryDirectory()
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testApplicationLogFilterDropsAppleShortcutNoise() throws {
    ...
    func testHomeAdbModeDisplay() throws {
    ...
    func testServerConfigTransportRoundTrip() throws {
    ...
    func testServerConfigWiredControllerAdapterRoundTrip() throws {
        ...
        """)
        try expect(parsed.wiredHeadset, "Expected wired headset parse")
        try expect(parsed.headsetMode == .wired, "Expected wired headset mode")
        ...
        let merged = parsed.merged(into: OXRSysServerConfig.defaultText)
        try expect(merged.contains("[wired]"), "Expected wired section serialization")
    ...
    func testWmrControllerServiceStatusParsing() throws {
        let data = Data("""
    ...
    func testServerConfigDefaultSerialization() throws {
    ...
    func testRuntimeActivityParsing() throws {
    ...
    func testMacWifiParsing() throws {
    ...
    func testAdbStatusDisplay() throws {
    ...
    func testDeveloperModePreferencePersistence() throws {
    ...
    private func makeExecutableScript(at url: URL, contents: String) throws {
