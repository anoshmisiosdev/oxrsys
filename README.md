...
- Linux: Vulkan and OpenGL GLX runtime streaming use bounded readback into the VA-API H.264/H.265 encoder path.
- Windows: Vulkan and Direct3D 11/12 runtime backends are buildable with Media Foundation H.264/H.265 streaming readback; OpenGL Win32/WGL remains a follow-up backend.
